...
<form action="userSettingCommit" method="post">
            <div class="mod-usetting-right">
                <div class="box mk com" id="basedetail">
                        ...
                        <div class="mainbox">
                            <div class="h30">
                                <div class="c c6">
                                    ...
                                    <div class="sh">
                                        <div class="txt">
                                            <input name="username" id="base_name" class="ef" maxlength="40" type="text" placeholder="${user.username}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="h30">
                                <div class="c c6">
                                    ...
                                    <div class="sh">
                                        <div class="txt">
                                            <input name="phone" id="base_phone" class="ef" maxlength="40" type="text" placeholder="${user.phone}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="h30">
                                <div class="c c6">
                                    ...
                                    <div class="sh">
                                        <div class="txt">
                                            <input  name="email" id="base_email" class="ef" maxlength="40" type="text" placeholder="${user.email}">
                                        </div>
                                    </div>
                                </div>
                            </div>
